...
lint-py:  ## lint python with ruff
	python -m ruff check pydantic_nomad
	python -m ruff format --check pydantic_nomad
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix pydantic_nomad
	python -m ruff format pydantic_nomad
...
test:  ## run python tests
	python -m pytest -v pydantic_nomad/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v pydantic_nomad/tests --cov=pydantic_nomad --cov-report term-missing --cov-report xml
